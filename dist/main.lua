type ConfigType__DARKLUA_TYPE_a = {Object: Instance, Camera: Instance?, Interactive: boolean?, Height: number?, Focused: boolean, Window: any, WindUI: any, Tab: any, Parent: Instance}
...
do
    function __DARKLUA_BUNDLE_MODULES.a()
        ...
        function DynamicShapeModule:New(
            Radius,
            Type,
            Properties,
            Children,
...
[[https://raw.githubusercontent.com/Footagesus/Icons/main/Main-v2.json]]))
        end)
    ...
    function __DARKLUA_BUNDLE_MODULES.d()
        ...
        local DynamicShapeModule = __DARKLUA_BUNDLE_MODULES.load('a')
...
[[https://raw.githubusercontent.com/Footagesus/Icons/main/Main-v2.lua]]
        ...
        function Creator.Init(WindUITable)
            WindUI = WindUITable
            Creator.ThemeFallbacks = __DARKLUA_BUNDLE_MODULES.load('c')(Creator)
    ...
    function __DARKLUA_BUNDLE_MODULES.k()
        return {
            ...
            junkiedevelopment = {
                ...
                New = __DARKLUA_BUNDLE_MODULES.load('j').New,
            },
        }
    end
...
[[{
    ...
    function __DARKLUA_BUNDLE_MODULES.p()
        ...
        local New = Creator.New
        local Tween = Creator.Tween
        local CreateButton = __DARKLUA_BUNDLE_MODULES.load('m').New
        local CreateInput = __DARKLUA_BUNDLE_MODULES.load('n').New

        function KeySystem.new(Config, Filename, func, keyValidator)
            local KeyDialogInit = __DARKLUA_BUNDLE_MODULES.load('o')
    ...
    function __DARKLUA_BUNDLE_MODULES.r()
        ...
        local Creator = __DARKLUA_BUNDLE_MODULES.load('d')
        local New = Creator.New
        local viewportPointToWorld, getOffset = unpack(__DARKLUA_BUNDLE_MODULES.load('q'))
    ...
    function __DARKLUA_BUNDLE_MODULES.s()
        local Creator = __DARKLUA_BUNDLE_MODULES.load('d')
        local AcrylicBlur = __DARKLUA_BUNDLE_MODULES.load('r')
        local New = Creator.New
    ...
    function __DARKLUA_BUNDLE_MODULES.t()
        ...
        local Acrylic = {
            AcrylicBlur = __DARKLUA_BUNDLE_MODULES.load('r'),
            AcrylicPaint = __DARKLUA_BUNDLE_MODULES.load('s'),
        }
    ...
    function __DARKLUA_BUNDLE_MODULES.u()
        ...
        function PopupModule.new(PopupConfig, Parent)
            ...
            local DialogInit = __DARKLUA_BUNDLE_MODULES.load('o')
    ...
    function __DARKLUA_BUNDLE_MODULES.x()
        ...
        function ScrollSlider.New(
            ...
            Creator.AddSignal(Hitbox.InputBegan, function(input)
                ...
                connectionMove = UserInputService.InputChanged:Connect(function(
                    moveInput
                )
                    if moveInput.UserInputType == Enum.UserInputType.MouseMovement or moveInput.UserInputType == Enum.UserInputType.Touch then
                        ...
                        ScrollingFrame.CanvasPosition = Vector2.new(ScrollingFrame.CanvasPosition.X, math.clamp(startCanvasY + scrollDelta, 0, maxScroll))
                    end
                end)
                connectionEnd = UserInputService.InputEnded:Connect(function(
                    endInput
                )
...
[[[ WindUI.ConfigManager ] The config system doesn't work in the studio.]])
    ...
    function __DARKLUA_BUNDLE_MODULES.C()
        ...
        local UserInputService = cloneref(game:GetService('UserInputService'))
        local TagModule = __DARKLUA_BUNDLE_MODULES.load('y')
...
-IconOffset, 1, 0)
            ...
            function Element.UpdateShape(Tab)
                if Config.Window.NewElements then
                    local newShape = Creator:GetElementPosition(Tab.Elements, Element.Index, Config.ParentConfig.ParentTable.__type == 'HStack' or Config.ParentConfig.ParentTable.__type == 'Group')
    ...
    function __DARKLUA_BUNDLE_MODULES.D()
        ...
        function Element:New(ElementConfig)
            ...
            local Paragraph = __DARKLUA_BUNDLE_MODULES.load('C')(ElementConfig)
    ...
    function __DARKLUA_BUNDLE_MODULES.E()
        ...
        function Element:New(Config)
            ...
            Button.ButtonFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
                Title = Button.Title,
                Desc = Button.Desc,
                Parent = Config.Parent,
...
-99999 or 99999
    ...
    function __DARKLUA_BUNDLE_MODULES.H()
        ...
        local New = Creator.New
        local Tween = Creator.Tween
        local CreateToggle = __DARKLUA_BUNDLE_MODULES.load('F').New
        local CreateCheckbox = __DARKLUA_BUNDLE_MODULES.load('G').New
        local Element = {}
        ...
        function Element:New(Config)
            ...
            Toggle.ToggleFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
                Title = Toggle.Title,
                Desc = Toggle.Desc,
                Window = Config.Window,
                Parent = Config.Parent,
            ...
            if Config.Window.NewElements and ToggleFunc.Animate then
                if Toggle.Type == 'Toggle' then
                    Creator.AddSignal(ToggleFrame.ToggleFrame.Hitbox.InputBegan, function(
                        Input
                    )
    ...
    function __DARKLUA_BUNDLE_MODULES.I()
        ...
        function Element:New(Config)
            ...
            Slider.SliderFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
                Title = Slider.Title,
                Desc = Slider.Desc,
                Parent = Config.Parent,
...
-12 - 4 or 0) or 0, 0.5, 0),
            ...
            if Slider.IsTooltip then
                Tooltip = __DARKLUA_BUNDLE_MODULES.load('B').New(Value, Slider.UIElements.SliderIcon.Frame.Thumb, true, 'Secondary', 'Small', false)
    ...
    function __DARKLUA_BUNDLE_MODULES.J()
        ...
        function Element:New(Config)
            ...
            local DefaultValue = typeof(Config.Value) == 'number' and Config.Value or ToFiniteNumber(ValueConfig.Default) or ToFiniteNumber(Config.Default) or Min
            ...
            local function GetValueText(Value, Ratio)
                ...
                if typeof(ProgressBar.Format) == 'function' then
                    local Success, Result = pcall(ProgressBar.Format, Value, Percentage, ProgressBar.Value.Min, ProgressBar.Value.Max)
            ...
            ProgressBar.ProgressBarFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
            ...
            ProgressBar.UIElements.Fill = Creator.NewRoundFrame(99, 'Squircle', {
                Name = 'Fill',
                Size = ProgressBar.Indeterminate and UDim2.new(0.3, 0, 1, 0) or UDim2.new(GetRatio(ProgressBar.Value.Default), 0, 1, 0),
            ...
            if ProgressBar.Indeterminate then
                local IndeterminateTween = Tween(ProgressBar.UIElements.Fill, 1 / ProgressBar.Speed, {
                    Position = UDim2.new(1, 0, 0, 0),
            ...
            local function Update(Value, Instant)
                ...
                if ProgressBar.UIElements.Fill and not ProgressBar.Indeterminate then
                    if Instant or not ProgressBar.Animate or ProgressBar.AnimationDuration <= 0 then
                        ...
                        Tween(ProgressBar.UIElements.Fill, ProgressBar.AnimationDuration, {Size = Size}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                    end
                end
    ...
    function __DARKLUA_BUNDLE_MODULES.K()
        ...
        local CreateLabel = __DARKLUA_BUNDLE_MODULES.load('w').New
        ...
        function Element:New(Config)
            ...
            Keybind.KeybindFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
                Title = Keybind.Title,
                Desc = Keybind.Desc,
                Parent = Config.Parent,
                TextOffset = 85,
    ...
    function __DARKLUA_BUNDLE_MODULES.L()
        ...
        function Element:New(Config)
            ...
            Input.InputFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
                Title = Input.Title,
                Desc = Input.Desc,
                Parent = Config.Parent,
...
-7),
            ...
            function DropdownModule:Refresh(Values)
                ...
                for Index, Tab in next, Values do
                    if Tab.Type ~= 'Divider' then
                        ...
                        __DARKLUA_BUNDLE_MODULES.load('M'):New({
                            Parent = Dropdown.UIElements.Menu.Frame.ScrollingFrame,
                        })
                    end
                end
    ...
    function __DARKLUA_BUNDLE_MODULES.O()
        ...
        local CreateLabel = __DARKLUA_BUNDLE_MODULES.load('w').New
        local CreateInput = __DARKLUA_BUNDLE_MODULES.load('n').New
        local CreateDropdown = __DARKLUA_BUNDLE_MODULES.load('N').New
        local CurrentCamera = workspace.CurrentCamera
        local Element = {
            UICorner = 10,
            UIPadding = 12,
        ...
        function Element:New(Config)
            ...
            Dropdown.DropdownFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
    ...
    function __DARKLUA_BUNDLE_MODULES.Q()
        ...
        local New = Creator.New
        local Tween = Creator.Tween
        local Highlighter = __DARKLUA_BUNDLE_MODULES.load('P')
        ...
        function Code.New(Code, Window, Parent, Callback, UIScale)
            ...
            local CopyButton = Code.CanCopied and New('TextButton', {
                BackgroundTransparency = 1,
            ...
            local CodeFrame, CodeFrameModule = Creator.NewRoundFrame(CodeModule.Radius, 'Squircle', {
                ...
                Size = Code.Height ~= nil and UDim2.new(1, 0, Code.Height.Scale, Code.Height.Offset == 0 and 
-20 * 2 or Code.Height.Offset) or UDim2.new(1, 0, 0, 20 + (CodeModule.Padding * 2)),
            ...
            Creator.AddSignal(TextLabel:GetPropertyChangedSignal('TextBounds'), function(
                ...
                if Code.Height ~= nil then
                    ScrollingFrame.Size = UDim2.new(1, 0, 1, Code.Title ~= nil and 
-(20 + (CodeModule.Padding * 2)) or nil)
                else
            ...
            if CopyButton then
                Creator.AddSignal(CopyButton.InputBegan, function(
                    Input: InputObject
                )
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
    ...
    function __DARKLUA_BUNDLE_MODULES.R()
        local Creator = __DARKLUA_BUNDLE_MODULES.load('d')
        local New = Creator.New
        local CodeComponent = __DARKLUA_BUNDLE_MODULES.load('Q')
        local Element = {}
        ...
        function Element:New(Config)
            ...
            function Code.UpdateShape(Tab)
                if Config.Window.NewElements then
                    local newShape = Creator:GetElementPosition(Tab.Elements, Code.Index, Config.ParentType == 'HStack' or Config.ParentType == 'Group')

                    if newShape and CodeElement.CodeFrameModule then
                        CodeElement.CodeFrameModule:SetType(newShape)
                        print(newShape)
                        CodeElement.TopbarFrameModule:SetType(table.find({
                            'Squircle-BL-BR',
                            'SquircleH-BL-BR',
                        }, newShape) ~= nil and 'Square' or newShape)
                    end
                end
            end

            Code.UIElements = {
                Main = CodeElement.CodeFrame,
            }
    ...
    function __DARKLUA_BUNDLE_MODULES.S()
        ...
        function Element:Colorpicker(Config, Window, WindUI, OnApply)
            ...
            local ColorpickerModule = __DARKLUA_BUNDLE_MODULES.load('o')
            ...
            Colorpicker.UIElements.Inputs = New('Frame', {
                AutomaticSize = 'XY',
                Size = UDim2.new(0, 0, 0, 0),
                Position = UDim2.fromOffset(IsTransparency and 160 + 10 + 10 + 10 + 10 + 10 + 10 + 20 or 160 + 10 + 10 + 10 + 20, 40 + Colorpicker.TextPadding),
                BackgroundTransparency = 1,
                Parent = ColorpickerFrame.UIElements.Main,
            }, {
                New('UIListLayout', {
            ...
            table.insert(Connections, Creator.AddSignal(HexInput.Frame.Frame.TextBox.FocusLost, function(
                Enter
            )
                if Enter then
            ...
            table.insert(Connections, Colorpicker.UIElements.SatVibMap.InputBegan:Connect(function(
                input
            )
                if input.UserInputType ~= Enum.UserInputType.MouseButton1 and input.UserInputType ~= Enum.UserInputType.Touch then
                    return
            ...
            table.insert(Connections, HueSlider.InputBegan:Connect(function(
                input
            )
                if input.UserInputType ~= Enum.UserInputType.MouseButton1 and input.UserInputType ~= Enum.UserInputType.Touch then
                    return
            ...
            if TransparencySlider then
                table.insert(Connections, TransparencySlider.InputBegan:Connect(function(
                    input
                )
                    if input.UserInputType ~= Enum.UserInputType.MouseButton1 and input.UserInputType ~= Enum.UserInputType.Touch then
                        return
        ...
        function Element:New(Config)
            ...
            Colorpicker.ColorpickerFrame = __DARKLUA_BUNDLE_MODULES.load('C')({
            ...
            Creator.AddSignal(Colorpicker.UIElements.Colorpicker.MouseButton1Click, function(
                ...
                if CanCallback and not Colorpicker.IsShowed then
                    ...
                    Element:Colorpicker(Colorpicker, Config.Window, Config.WindUI, function(
                        color,
                        transparency
                    )
    ...
    function __DARKLUA_BUNDLE_MODULES.Z()
        ...
        function Element:New(Config: ConfigType__DARKLUA_TYPE_a)
            local Viewport = {
                __type = 'Viewport',
            ...
            Creator.AddSignal(Main.CanvasGroup.Viewport.InputEnded, function(
                Input
            )
            ...
            Creator.AddSignal(Main.CanvasGroup.Viewport.InputBegan, function(
                Input
            )
                if Viewport.Interactive then
...
-Position) * Camera.CFrame
            ...
            Creator.AddSignal(Main.CanvasGroup.Viewport.InputChanged, function(
                Input
            )
                if Viewport.Interactive then
            ...
            Creator.AddSignal(UserInputService.TouchPinch, function(
                touchPositions,
                scale,
                velocity,
                state
    ...
    function __DARKLUA_BUNDLE_MODULES._()
        return {
            Elements = {
                Paragraph = __DARKLUA_BUNDLE_MODULES.load('D'),
                Button = __DARKLUA_BUNDLE_MODULES.load('E'),
                Toggle = __DARKLUA_BUNDLE_MODULES.load('H'),
                Slider = __DARKLUA_BUNDLE_MODULES.load('I'),
                ProgressBar = __DARKLUA_BUNDLE_MODULES.load('J'),
                Keybind = __DARKLUA_BUNDLE_MODULES.load('K'),
                Input = __DARKLUA_BUNDLE_MODULES.load('L'),
                Dropdown = __DARKLUA_BUNDLE_MODULES.load('O'),
                Code = __DARKLUA_BUNDLE_MODULES.load('R'),
                Colorpicker = __DARKLUA_BUNDLE_MODULES.load('S'),
                Section = __DARKLUA_BUNDLE_MODULES.load('T'),
                Divider = __DARKLUA_BUNDLE_MODULES.load('M'),
                Space = __DARKLUA_BUNDLE_MODULES.load('U'),
                Image = __DARKLUA_BUNDLE_MODULES.load('V'),
                Group = __DARKLUA_BUNDLE_MODULES.load('W'),
                HStack = __DARKLUA_BUNDLE_MODULES.load('X'),
                VStack = __DARKLUA_BUNDLE_MODULES.load('Y'),
                Viewport = __DARKLUA_BUNDLE_MODULES.load('Z'),
            },
            Load = function(
                tbl,
                Container,
    ...
    function __DARKLUA_BUNDLE_MODULES.aa()
        ...
        local Creator = __DARKLUA_BUNDLE_MODULES.load('d')
        local New = Creator.New
        local CreateToolTip = __DARKLUA_BUNDLE_MODULES.load('B').New
        local CreateScrollSlider = __DARKLUA_BUNDLE_MODULES.load('x').New
        ...
        function TabModule.New(Config, UIScale)
            ...
            if Window.ScrollBarEnabled then
                CreateScrollSlider(Tab.UIElements.ContainerFrame, Tab.UIElements.ContainerFrameCanvas.ScrollSliderHolder, Window, 4, WindUI)
            end
            ...
            local ElementsModule = __DARKLUA_BUNDLE_MODULES.load('_')
    ...
    function __DARKLUA_BUNDLE_MODULES.ab()
        ...
        local New = Creator.New
        local Tween = Creator.Tween
        local TabModule = __DARKLUA_BUNDLE_MODULES.load('aa')
...
-SectionModule.IconSize - 10), 1, 0),
    ...
    function __DARKLUA_BUNDLE_MODULES.ad()
        ...
        function SearchBar.new(TabModule, Parent, OnClose)
            local SearchBarModule = {
                ...
                Width = 400,
                MaxHeight = 380,
                Icons = __DARKLUA_BUNDLE_MODULES.load('ac'),
            }
            local TextBox = New('TextBox', {
                Text = '',
    ...
    function __DARKLUA_BUNDLE_MODULES.ae()
        ...
        local Players = cloneref(game:GetService('Players'))
        local CurrentCamera = workspace.CurrentCamera
        local Acrylic = __DARKLUA_BUNDLE_MODULES.load('t')
        local Creator = __DARKLUA_BUNDLE_MODULES.load('d')
        local New = Creator.New
        local Tween = Creator.Tween
        local CreateLabel = __DARKLUA_BUNDLE_MODULES.load('w').New
        local CreateButton = __DARKLUA_BUNDLE_MODULES.load('m').New
        local CreateScrollSlider = __DARKLUA_BUNDLE_MODULES.load('x').New
        local Tag = __DARKLUA_BUNDLE_MODULES.load('y')
        local ConfigManager = __DARKLUA_BUNDLE_MODULES.load('z')
...
-Window.Topbar.Height - 42 - (Window.UIPadding * 2) or -Window.Topbar.Height),
                ...
                New('Frame', {
                    Name = 'Content',
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, 0, 1, not Window.HideSearchBar and -39 - 6 - Window.UIPadding or 
-Window.UIPadding / 2),
            ...
            if Window.ScrollBarEnabled then
                CreateScrollSlider(Window.UIElements.SideBar, Window.UIElements.SideBarContainer.Content, Window, 3, Config.WindUI)
            end
...
[[[ WindUI.Window.Background ] VideoFrame may not work with custom video]])
            ...
            function Window.Topbar:Button(ButtonConfig: {Name: string, Icon: string, Callback: any, LayoutOrder: number, IconThemed: boolean, Color: Color3, IconSize: number})
            ...
            Window.OpenButtonMain = __DARKLUA_BUNDLE_MODULES.load('A').New(Window)
            ...
            local TabModuleMain = __DARKLUA_BUNDLE_MODULES.load('aa')
            local SectionModule = __DARKLUA_BUNDLE_MODULES.load('ab')
            ...
            local DialogModule = __DARKLUA_BUNDLE_MODULES.load('o')
...
[[Do you want to close this window? You will not be able to open it again.]],
            ...
            if not Window.HideSearchBar then
                local SearchBar = __DARKLUA_BUNDLE_MODULES.load('ad')
                local IsOpen = false
...
local WindUI = {
    ...
    ConfigManager = nil,
    Version = '0.0.0',
    Services = __DARKLUA_BUNDLE_MODULES.load('k'),
...
local Package = HttpService:JSONDecode(__DARKLUA_BUNDLE_MODULES.load('l'))

if Package then
    WindUI.Version = Package.version
end

local KeySystem = __DARKLUA_BUNDLE_MODULES.load('p')
...
function WindUI:Popup(PopupConfig)
    ...
    return __DARKLUA_BUNDLE_MODULES.load('u').new(PopupConfig, WindUI.ScreenGui.Popups)
end

WindUI.Themes = __DARKLUA_BUNDLE_MODULES.load('v')(WindUI, Creator)
...
function WindUI:CreateWindow(Config)
    local CreateWindow = __DARKLUA_BUNDLE_MODULES.load('ae')
